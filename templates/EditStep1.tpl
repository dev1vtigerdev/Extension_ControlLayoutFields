...
{strip}
    <div class="controlLayoutFieldsContents" style="padding-left: 3%;padding-right: 3%">
        <form name="EditControlLayoutFields" action="index.php" method="post" id="controllayoutfields_step1" class="form-horizontal">
            ...
            <div class="padding1per" style="border:1px solid #ccc;">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {if $MODE eq 'edit'}
                            <input type='text' disabled='disabled' value="{vtranslate($MODULE_MODEL['module'], 'Vtiger')}" >
