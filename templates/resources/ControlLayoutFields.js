                                ...
                                case 'read_only':
                                    ...
                                    if (typeof data_info !== 'undefined'){
                                        if(data_info.type == 'reference'){
                                            var parent_span = form_element.closest('.input-prepend');
                                            parent_span.css('cursor','not-allowed');
                                            parent_span.find('span').css('pointer-events','none');
                                        }
                                        if(data_info.type == 'multipicklist'){
                                            form_element.select2('disable');
                                        }
                                        //#1353904
                                        if(data_info.type == 'date'){
                                            form_element.prop('disabled', true);
                                        }
                                         //#2054617
                                        if(data_info.type == 'picklist' || data_info.type == 'owner'){
                                            form_element.closest('td.fieldValue').css('cursor','not-allowed');
                                            var form_element_container = form_element.next('.chzn-container');
                                            form_element_container.css("pointer-events","none");
                                            form_element_container.find('a.chzn-single').css("background","rgb(235, 235, 228)");
                                        }
                                    }
                                    break;
                                case 'hide':
                        ...
                        jQuery.each(actions,function(key,value){
                            ...
                            if(form_element.hasClass(condition_key+'-clf-read-only')){
                                ...
                                if (typeof data_info !== 'undefined'){
                                    if(data_info.type == 'reference'){
                                        var parent_span = form_element.closest('.input-prepend');
                                        parent_span.css('cursor','unset');
                                        parent_span.find('span').css('pointer-events','unset');
                                    }
                                    if(data_info.type == 'multipicklist'){
                                    ...
                                    if(data_info.type == 'date'){
                                     ...
                                     //#2054617
                                    if(data_info.type == 'picklist' || data_info.type == 'owner'){
                                        form_element.closest('td.fieldValue').css('cursor','pointer');
                                        var form_element_container = form_element.next('.chzn-container');
                                        form_element_container.css("pointer-events","unset");
                                        form_element_container.find('a.chzn-single').css("background","none");
                                    }
                                }
                            }
