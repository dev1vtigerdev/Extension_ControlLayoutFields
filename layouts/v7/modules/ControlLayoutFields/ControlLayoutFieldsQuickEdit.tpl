<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form id="vteControlLayoutFieldsQuickEdit" name="vteControlLayoutFieldsQuickEdit" action="index.php" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" type="button" name="vteControlLayoutFieldsSave" ><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
            </div>
        </form>
    </div>
</div>